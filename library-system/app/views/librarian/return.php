<h2 class="mb-3">Return Processing</h2>
<div class="card">
        ...
        <table class="table table-striped mb-0">
            ...
            <?php foreach ($active as $item): ?>
                <tr>
                    ...
                    <td>
                        <form method="POST" action="/library-system/public/return/process">
                            <input type="hidden" name="csrf_token" value="<?= htmlspecialchars($csrf ?? '') ?>">
                            <input type="hidden" name="transaction_id" value="<?= (int)$item['id'] ?>">
                            <button class="btn btn-warning btn-sm">Mark Returned</button>
                        </form>
                    </td>
                </tr>
            <?php endforeach; ?>
